                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <h2 class="lead"><b>{{$admin->name}}</b></h2>
                      ...
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Email: {{$admin->email}}</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: +977-9817253327</li>
                      </ul>
                    </div>
                    <div class="col-5 text-center">
                    <img src="/storage/profileimages/{{$admin->profile_image}}"  alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
